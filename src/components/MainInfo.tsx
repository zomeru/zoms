...
const MainInfo = (): React.JSX.Element => {
  return (
    <div className='h-auto lg:h-[calc(100vh-180px)] flex flex-col lg:justify-between justify-normal lg:w-137.5 mr-auto w-full static lg:fixed'>
      <div className='space-y-3 mb-3 lg:mb-0'>
        ...
        <h3 className='max-w-87.5 text-textSecondary'>

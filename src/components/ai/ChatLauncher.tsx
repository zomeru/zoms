...
export function ChatLauncher({ onClick }: ChatLauncherProps) {
  return (
    <button
      ...
      className={`group fixed right-5 bottom-5 z-50 inline-flex items-center gap-3 px-3.5 py-3 text-left transition-all duration-200 hover:border-primary/40 hover:bg-surface md:right-8 md:bottom-8 ${FLOATING_WIDGET_TRIGGER_SHELL} ${FLOATING_WIDGET_TRIGGER_SHADOW}`}
    >
      <span

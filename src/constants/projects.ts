export const projects = [
  {
    ...
    techs: ['React Native CLI', 'Typescript', 'Tailwind CSS', 'OpenAI API', 'ChatGPT', 'Supabase'],
    links: {
  ...
  },
  {
    ...
    techs: ['Typescript', 'React.js', 'Next.js', 'Tailwind CSS', 'Node.js', 'MongoDB', 'Firebase'],
    links: {
  ...
  },
  {
    ...
    techs: ['Typescript', 'React.js', 'Next.js', 'Tailwind CSS', 'Firebase', 'Paymongo'],
    links: {

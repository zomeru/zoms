...
// Legacy PortableText components for backward compatibility
...
interface BlogContentProps {
  body?: PortableTextBlock[]; // Legacy block content
  bodyMarkdown?: string; // New markdown content
}

const BlogContent: React.FC<BlogContentProps> = ({ body, bodyMarkdown }) => {
  // Prefer markdown over block content
  if (bodyMarkdown) {
    return (
  ...
  // Fallback to legacy block content
  if (body) {
    return (
